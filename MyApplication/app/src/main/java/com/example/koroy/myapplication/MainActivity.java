...
import com.example.koroy.myapplication.fragment.FragmentDrawer;
...
public class MainActivity extends AppCompatActivity implements FragmentDrawer.FragmentDrawerListener {
    ...
    private TextView mainActHeader;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainActHeader=(TextView)mToolbar.findViewById(R.id.main_act_header);
        mainActHeader.setTypeface(font);
       ...
       //String title = getString(R.string.app_name);
        switch (position) {
            case 0:
                ...
                mainActHeader.setText("Home");
                break;
            case 1:
                fragment = new SalonsFragment();
                mainActHeader.setText("Salons");
                break;
            case 2:
                fragment = new OffersFragment();
                mainActHeader.setText("Offers");
                break;
            default:
                break;
        }
